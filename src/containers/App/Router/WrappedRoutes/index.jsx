...
import MyProgramDashboard from '../../../Dashboards/MyProgram/index';
import DefaultDashboard from '../../../Dashboards/Default/index';
import LibraryDashboard from '../../../Dashboards/Library/index';
import BookingDashboard from '../../../Dashboards/Booking/index';
import EmployeeDashboard from '../../../Dashboards/Employee/index';
...
export default () => (
  <div>
    ...
    <div className="container__wrap">
      ...
      <Route path="/employee_list" component={EmployeeDashboard} />
      <Route path="/my_programs" component={MyProgramDashboard} />
